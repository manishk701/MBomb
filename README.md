...
git clone https://github.com/manishk_k701/MBomb.git
cd MBomb
./MBomb.sh
```
...
**A:** There is no official website/app yet.The only official releases of MBomb are published in [Github](https://github.com/manishk_k701/MBomb) and [PyPi](https://pypi.org/project/mbomb)
##
