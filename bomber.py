...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/Manilok701/MBomb/archive/dev.zip"
        dir_name = "MBomb-dev"
    else:
        zip_url = "https://github.com/Manilok701/MBomb/archive/master.zip"
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/Manilok701/MBomb.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/Manilok701/MBomb.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/Manilok701/MBomb/master/.version"
    ).text.strip()
    if fver != __VERSION__:
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/Manilok701/MBomb/raw/dev/.notify"
        else:
            url = "https://github.com/Manilok701/MBomb/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("MBomb was created by TezX")
...
__CONTRIBUTORS__ = ['TezX', 't0xic0der', 'scpketer', 'Stefan']
