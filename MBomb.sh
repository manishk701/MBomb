...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mManish_k701 \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border Manish_k701
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Whatsapp Number: +91 9065790822 \e[0m"
    echo -e "\e[4;32m   Snapchat: https://www.snapchat.com/add/manish_k0701?share_id=dfY0WsZdoAY&locale=en-US \e[0m"
    echo " "
